...
Settled dates: ['2026-05-29']. Yesterday games settled: 43 picks.
...
Current streak: win 5. Rolling 14d 58.6% (n=29), 30d 63.9% (n=36).
Guard status: cap_active.
The 11:30 AM run will enforce the A tier cap rule until 14d recovers to 0.85.

## Section 4 Top Losses
- None

## Section 5 Rule Memory
Permanent rules (4): Never issue A-tier Under 7.0 at Oracle when the opposing sta... (v3); Never issue Giants ML as A-tier unless SF starting pitcher h... (v3); Cap A-tier exposure at 2 picks per game maximum. F5 Under 4 ... (v3); Never issue A-tier ML on any team when their offense ranks b... (v3)
Trial rules (7): Do not publish A tier F5 Under when the run suppre... v1/3; Do not publish A tier ML relying on ERA differenti... v1/3; Do not publish A tier Under at Oracle Park when th... v1/3; Do not publish A tier ML against a starter with ER... v1/3; Do not publish A tier Over when the visiting team'... v1/3; Do not publish A tier pitcher K over at a line of ... v1/3; Require the pitcher trailing 5 start strikeout rat... v1/3
Total active: 4 permanent + 7 trial.
...
picks_log entries 373 | outcomes 1129
...
wrote learnings.json
wrote retrospective_history.json